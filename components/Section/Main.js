        ...
        <div className="h-full lg:mx-auto bg-local ">
          <div className="md:p-4  h-full shadow-inner bg-hero-pattern">
            <div className="container h-full  mx-auto block__custom justify-evenly flex flex-col">
              ...
              <a className="mx-auto flex flex-col border-0 next block transform hover:translate-y-4 duration-500 text-center font-bold uppercase text-gray-500 tracking-wider"  href="#">Далее<Chevron clme={' -mt-8 w-16 h-16 mx-auto'} /></a>
            </div>
          </div>
        </div>
      </Section>
