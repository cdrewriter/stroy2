...
export default function ConstructionSection({ data, items }) {
  ...
  function inHtml() {
    return  <div className="block__desc" dangerouslySetInnerHTML={{ __html: `${data.description}` }} />;
  }
  return (
    <Section className="construction  bg-gradient-to-r from-red-500">
      <div className="lg:mx-auto bg-local relative">
        ...
        <div className="py-40 bg-gray-100">
          <div className="container h-full mx-auto block__custom mt-12 ">
            ...
            <div className="block__desc sub__desc my-12">
              <p>
                {" "}
