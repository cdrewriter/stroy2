...
export const IconArrowDown = (props) => {
    return (
        <div className={props.className}>
            <svg xmlns="http://www.w3.org/2000/svg" width="49.672" height="30.615" viewBox="0 0 49.672 30.615">
                <g id="arrow-down" transform="translate(5.657 5.657)">
                    <line id="line" y1="26.87" transform="translate(19.358 19.104) rotate(-135)" fill="none" stroke="#fca311" stroke-linecap="round" stroke-width="8"/>
                    <path id="line-2" data-name="line" d="M27.3,0H0" transform="translate(19.302 19.302) rotate(-135)" fill="none" stroke="#fca311" stroke-linecap="round" stroke-width="8"/>
                </g>
            </svg>
        </div>
    )
...
export const IconArrowRight = () => {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" width="13.955" height="21.692" viewBox="0 0 13.955 21.692">
            <g id="Сгруппировать_213" data-name="Сгруппировать 213" transform="translate(-334.143 -5.982)">
                <g id="Chevron" transform="translate(336.863 27.566) rotate(-135)">
                    <g id="Сгруппировать_199" data-name="Сгруппировать 199" transform="translate(0 0)">
                        <path id="Контур_74" data-name="Контур 74" d="M0,14.71C0,11.308.425,0,.425,0" transform="translate(0 13.814) rotate(-90)" fill="none" stroke="" stroke-width="4"/>
                        <path id="Контур_4" data-name="Контур 4" d="M13.436,0H0" transform="translate(1.847 13.436) rotate(-90)" fill="none" stroke="" stroke-width="4"/>
                    </g>
                </g>
            </g>
        </svg>
