...
function ItemCategory({ itemcategory }) {
  ...
  return (
      <Grid item item xs={6} sm={6} md={4}>
        <Link href={`/price/[slugcat]?slugcat=${itemcategory.slugcat}`} as={`/price/${itemcategory.slugcat}`} passHref>
        <a
            css={{
            display: 'block',
        ...
        >
            <h3 css={{ marginTop: 0 }}>{itemcategory.name}</h3>
...
const PirceCatSection = () => {
  const classes = useStyles();
  return (
    <Section className="intro-section">
        <Box my={12} py={10} className="partsbg" bgcolor="text.primary">
                    ...
                    {loading ? (
                        ...
                        <Grid container spacing={3}>
                            ...
                            {data.allItemCategories.length ? (
                            data.allItemCategories.map(itemcategory => <ItemCategory itemcategory={itemcategory} key={itemcategory.id} slugcat={itemcategory.slugcat} items={itemcategory.items}/>)
                            ) : (
...
PirceCatSection.propTypes = {};

export default PirceCatSection;
