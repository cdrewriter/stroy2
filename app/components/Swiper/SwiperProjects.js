...
export default function SwiperProjects() {
    return (
        <>
        <div className={'main onescreen ourPortfolio'}>

            <div className={'header'}>
                <h2>ПОСЛЕДНИЕ РАБОТЫ</h2>
                <span className={'UPheading'}>построенные дома и проведенные реконструкции</span>
                <div className={'content__header'}>
                    <p> На протяжении этих лет работы компанией успешно
                        реализовано множество объектов, в области строительства частного
                        домостроения, торговых и производственных построек.</p>
                </div>
            </div>
            <div className={'links'}>
                <a className={'btn btn-filled'}>Все объекты</a>
                <a className={'btn '}>Все объекты</a>
            </div>
        </div>
